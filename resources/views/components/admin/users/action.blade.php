    ...
    <div class="relative inline-block text-left"
        ...
        <template x-teleport="body">
            <div
                ...
                @can('users.detail')
                    <a href="{{ route('admin.user.detail', $item->id) }}" wire:navigate
                ...
                @can('users.update')
                    <a href="{{ route('admin.user.update', $item->id) }}" wire:navigate
                ...
                @can('users.delete')
                    ...
                    <button type="button" wire:click="delete({{ $item->id }})"
                        wire:confirm="Delete user "{{ $item->name }}"? This cannot be undone."
                        title="Delete"
