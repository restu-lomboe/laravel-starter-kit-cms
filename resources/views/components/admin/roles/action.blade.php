    ...
    <div class="relative inline-block text-left"
        ...
        <template x-teleport="body">
            <div
                ...
                @can('roless.detail')
                    <a href="{{ route('admin.roles.detail', $item->id) }}" wire:navigate
                ...
                @can('roless.update')
                    <a href="{{ route('admin.roles.update', $item->id) }}" wire:navigate
                ...
                @can('roless.delete')
                    ...
                    <button type="button" wire:click="delete({{ $item->id }})"
                        wire:confirm="Delete roles "{{ $item->name }}"? This cannot be undone."
                        title="Delete"
